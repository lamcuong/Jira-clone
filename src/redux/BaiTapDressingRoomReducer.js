const initialState = {
    ...
    "model": {
        hairstyle: './images/hairstyle/hairstyle1.png', necklaces: './images/necklaces/necklace3.png', topclothes: './images/clothes/topcloth2.png', botclothes: './images/clothes/botcloth4.png', handbags: './images/handbags/handbag1.png', shoes: './images/shoes/shoes4.png', background: './images/background/background4.jpg'
    }
}
    ...
    switch (action.type) {
        case "THU_DO": {
            ...
            for (let key in modelUpdate) {
                ...
                if (key === action.item.type) {
                    modelUpdate[key] = action.item.imgSrc_png
                    state.model = modelUpdate
                    return { ...state }
                }
